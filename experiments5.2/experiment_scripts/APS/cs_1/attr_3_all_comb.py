...
from params_experiments_3 import *
import datetime
...
for num in comb_list_num:
    ...
    parallel_ver_hor_solve_attck_problem(attacker = att, 
                               ...
                               save_dir_ite = par_d[num]['save_ite_d_RS'], 
                                save_glb = par_d[num]['save_gb_b'] , 
                                save_dir_glb = par_d[num]['save_gb_d_RS'] , 
                               exp_str = par_d[num]['id_str'],
                               flag_dir = par_d[num]['flag_d_RS'])

    end = time.time()
    
    print('RS solver finished ...')
    print('Time for solving RS ...', str(datetime.timedelta(seconds=(end-start))))
    ...
    print('COMBINATION # ...',  comb_list_num, ' finished !')
