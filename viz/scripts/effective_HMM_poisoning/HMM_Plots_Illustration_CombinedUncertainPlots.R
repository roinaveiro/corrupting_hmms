...
df = read_csv('state_attraction_repulsion/att_low_unc_ratio.csv')
df1 = read_csv('state_attraction_repulsion/att_high_unc_ratio.csv')
...
df = read_csv('state_attraction_repulsion/rep_low_unc_ratio.csv')
df = df[df$ratio <= 105,]
df1 = read_csv('state_attraction_repulsion/state_rep_high_unc_ratio.csv')
...
df = read_csv('distribution_disruption/dd_low_unc_ratio.csv')
df1 = read_csv('distribution_disruption/dd_high_unc_ratio.csv')
...
df = read_csv('poisoning_decoding/pd_low_unc_ratio.csv')
...
fig4 =ggplot(data = df, aes(x=ratio)) +
  ...
  scale_x_continuous(name = TeX("$w_1 /w_2$"), breaks=seq(0,10,1), limits = c(0,11)) +
  theme(panel.border = element_blank(), panel.background =element_blank(),panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"), text = element_text(size = 22))

#Path Attract High Uncertainty
df1 = read_csv('poisoning_decoding/pd_high_unc_ratio.csv')
