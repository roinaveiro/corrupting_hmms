library(tidyverse)
source("utils.R")
# Experiments Structure testing
### Fill with directories

## APS - 500
path_APS = "results/experiment_3_scaled_csv/APS"
...
## RME
path_RME = "results/experiment_3_scaled_csv/RME"
