...
#from random_mc_ennumeration import *
import pandas as pd
import json
...
def solve_attacker_problem(attacker, solver_str, sim_sec, idx = 0, 
                      params_solver = {'APS': {'cooling_schedule':np.arange(500, 1000000, 10)},
                                       'MCTS': {'RS_iters': 5000, 'mcts_iters':100 ,
                                                    'eps': 0.05, 'lr':0.005, 'flag': 'MCTS'},
                                        'SA': {'RS_iters': 5000, 'sa_iters':100 ,
                                                    'eps': 0.05, 'lr':0.005, 'flag': 'SA'},
                                         'RME': {'N': 100}}, 
    ...
    if solver_str == 'APS':
        ...
        solver = random_mc_ennumeration(attacker, **params_solver[solver_str])
             ...
             'rho': attacker.rho_probs[0],
              'k': attacker.k_value,
               'utility_time': end-start,
                'params_solver_dict': str(params_solver)}
