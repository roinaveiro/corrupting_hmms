...
df = read_csv('state_attraction_repulsion/att_low_unc_box.csv')
...
df = read_csv('state_attraction_repulsion/att_high_unc_box.csv')
...
df = read_csv('state_attraction_repulsion/rep_low_unc_box.csv')
...
#State-Attraction high Uncertainty
df = read_csv('state_attraction_repulsion/rep_high_unc_box.csv')
...
df = read_csv('distribution_disruption/dd_low_unc_box.csv')
...
df = read_csv('distribution_disruption/dd_high_unc_box.csv')
#df$res_std_plus3 =  df$res + 3/2 * (df$res_std_plus - df$res) 
#df$res_std_minus3 =  df$res - 3/2 * (df$res-df$res_std_minus)
...
df = read_csv('poisoning_decoding/pd_low_unc_box.csv')
...
df = read_csv('poisoning_decoding/pd_high_unc_box.csv')
